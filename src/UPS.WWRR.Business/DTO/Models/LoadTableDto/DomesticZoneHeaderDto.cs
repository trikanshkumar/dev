...
{
    /// <summary>
    /// DTO representing TDOZNHD (Domestic Zone Header) with property names matching column names.
    /// Used for CSV validation and batch loading.
    /// </summary>
    public class DomesticZoneHeaderDto
    {
        ...
        [Required]
        public DateTime DOM_ZN_HDR_END_DT { get; set; }
