...
{
    /// <inheritdoc />
    public partial class AddTASYBRLTable : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_tasybrl", x => new { x.brl_typ_cd, x.gpn_xpt_cny_cd, x.gpn_ipt_cny_cd, x.pkg_cha_typ_cd, x.bil_ter_typ_cd, x.svc_fea_typ_cd, x.svc_typ_cd, x.mvm_drc_cd, x.cus_csf_typ_cd, x.asy_svc_typ_cd, x.apv_sts_cd, x.rec_eff_stt_dt });
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_tasybrl_stg", x => new { x.brl_typ_cd, x.gpn_xpt_cny_cd, x.gpn_ipt_cny_cd, x.pkg_cha_typ_cd, x.bil_ter_typ_cd, x.svc_fea_typ_cd, x.svc_typ_cd, x.mvm_drc_cd, x.cus_csf_typ_cd, x.asy_svc_typ_cd, x.apv_sts_cd, x.rec_eff_stt_dt });
                });
        }
