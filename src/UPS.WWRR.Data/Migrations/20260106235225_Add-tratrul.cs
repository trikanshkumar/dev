...
{
    /// <inheritdoc />
    public partial class Addtratrul : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    rtg_cny_cd = table.Column<string>(type: "char(2)", maxLength: 2, nullable: false),
                    ...
                    mps_pkg_ir = table.Column<string>(type: "char(2)", maxLength: 2, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_tratrul", x => new { x.rtg_cny_cd, x.cny_ra_sei_rl_cd, x.cus_csf_typ_cd, x.svc_typ_cd, x.mps_pkg_ir, x.tbl_row_eff_dt, x.tbl_row_end_dt, x.apv_sts_cd });
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_tratrul_stg", x => new { x.rtg_cny_cd, x.cny_ra_sei_rl_cd, x.cus_csf_typ_cd, x.svc_typ_cd, x.mps_pkg_ir, x.tbl_row_eff_dt, x.tbl_row_end_dt, x.apv_sts_cd });
                });
        }
