...
namespace UPS.WWRR.Data.Migrations
{
    ...
    [Migration("20260603194158_Update-taltccy-user_nr-not-null")]
    partial class Updatetaltccyuser_nrnotnull
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("UPS.WWRR.Data.Models.QaValidationResult", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.ToTable("qa_validation_results", "a886aa_ao", t =>
                        {
                            t.HasCheckConstraint("chk_results_validation_status", "validation_status IN ('PASS','FAIL')");
                        });
                });

            modelBuilder.Entity("UPS.WWRR.Data.Models.QaValidationTracker", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.HasIndex("LoadVersion", "LoadTableName")
                        .IsUnique()
                        .HasDatabaseName("uq_exec");

                    b.ToTable("qa_validation_tracker", "a886aa_ao", t =>
                        {
                            t.HasCheckConstraint("chk_tracker_validation_status", "validation_status IN ('IN_PROGRESS','COMPLETED','FAILED')");
                        });
                });
