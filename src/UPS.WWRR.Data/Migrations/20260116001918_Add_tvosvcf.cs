...
{
    /// <inheritdoc />
    public partial class Add_tvosvcf : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_tvosvcf", x => new { x.gpn_xpt_cny_cd, x.svc_typ_cd, x.svc_fea_typ_cd, x.tbl_row_eff_dt, x.apv_sts_cd });
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_tvosvcf_stg", x => new { x.gpn_xpt_cny_cd, x.svc_typ_cd, x.svc_fea_typ_cd, x.tbl_row_eff_dt, x.apv_sts_cd });
                });
        }
