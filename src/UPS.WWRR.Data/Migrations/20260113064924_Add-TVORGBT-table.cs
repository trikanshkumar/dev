...
{
    /// <inheritdoc />
    public partial class AddTVORGBTtable : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_tvorgbt", x => new { x.gpn_xpt_cny_cd, x.bil_ter_typ_cd, x.apv_sts_cd, x.rec_eff_stt_dt });
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_tvorgbt_stg", x => new { x.gpn_xpt_cny_cd, x.bil_ter_typ_cd, x.apv_sts_cd, x.rec_eff_stt_dt });
                });
        }
