CREATE OR REPLACE PROCEDURE sp_informationalaccessorialrate_merge_proc(
...
BEGIN
    CREATE TEMP TABLE merge_actions (
        ...
        ccy_cd text,
        dtr_cri_eff_dt date,
        dtr_cri_low_rng_te decimal,
        dtr_cri_hi_rng_te decimal,
        dtr_cri_end_dt date,
        ccl_mth_typ_cd text,
        dtr_cri_ra_a decimal,
        cus_csf_typ_cd text
    );
    ...
    cc_merge AS (
        ...
        ON (
            ...
            tgt.dtr_cri_low_rng_te = src.dtr_cri_low_rng_te AND
        ...
        RETURNING
            ...
            COALESCE(tgt.dtr_cri_low_rng_te, src.dtr_cri_low_rng_te) AS dtr_cri_low_rng_te,
            COALESCE(tgt.dtr_cri_hi_rng_te,  src.dtr_cri_hi_rng_te)  AS dtr_cri_hi_rng_te,
    ...
    INSERT INTO merge_actions (
        table_name, action,
        cny_cd, asy_svc_typ_cd, tm_prd_typ_cd, ccy_cd, dtr_cri_eff_dt, dtr_cri_low_rng_te, dtr_cri_hi_rng_te, dtr_cri_end_dt, ccl_mth_typ_cd, dtr_cri_ra_a, cus_csf_typ_cd
    )
    SELECT
        'tinfrat', merge_action,
        cny_cd, asy_svc_typ_cd, tm_prd_typ_cd, ccy_cd, dtr_cri_eff_dt, dtr_cri_low_rng_te, dtr_cri_hi_rng_te, dtr_cri_end_dt, ccl_mth_typ_cd, dtr_cri_ra_a, cus_csf_typ_cd
    FROM cc_merge;
    ...
    ErrorNumber    := NULL;
    ErrorState     := NULL;
    ErrorProcedure := 'sp_informationalaccessorialrate_merge_proc';
    ErrorLine      := NULL;
    ErrorMessage   := NULL;
