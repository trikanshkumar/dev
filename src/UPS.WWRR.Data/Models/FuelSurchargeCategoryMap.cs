...
/// <summary>
/// Represents the TFSCMAP (Fuel Surcharge Category Map) main table.
/// </summary>
[Table("tfscmap")]
[PrimaryKey(
...
[Index(nameof(LoadReference), Name = "idx_tfscmap_load_ref_te")]
public class FuelSurchargeCategoryMap
{
