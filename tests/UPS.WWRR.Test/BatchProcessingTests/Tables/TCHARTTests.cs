...
public class TCHARTTests : BatchProcessorTests
{
    ...
    public async Task PerformMergeLoadAsync_RateChart_StagingFails_SetsFailedStatus()
    {
        ...
        _repo.Verify(r => r.UpdateStatusAsync(4330, LoadStatus.Failed, It.IsAny<DateTime>(), It.IsAny<CancellationToken>()), Times.Once);
    }
    ...
    public async Task PerformMergeLoadAsync_RateChart_MergeFails_SetsFailedStatus()
    {
        ...
        // Assert
        _repo.Verify(r => r.UpdateStatusAsync(4331, LoadStatus.Failed, It.IsAny<DateTime>(), It.IsAny<CancellationToken>()), Times.Once);
    }
